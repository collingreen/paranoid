 ...
 * - version: (optional, default 1) 'version' of password for a given site
 *
...
function paranoid (opts) {
  ...
  // use version to create an extra input based on the password
  var rng = new seedrandom(masterPassword);
  var extra;
  for (var i = 0; i < version; i++) {
    extra = rng();
  }

  // combine master password and version-based extra
  var newPassword = masterPassword + extra;
